...
router
    ...
    .post('/v1/cards/:code/add', (req: Request, res: Response) =>
        userCardController.add(req, res)
    )
    .post('/v1/cards/:code/subtract', (req: Request, res: Response) =>
        userCardController.subtract(req, res)
    );
